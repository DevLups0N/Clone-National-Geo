/* 
 -  Navegação por tabs:
 É quando temos um intem ou objeto se relacionando com outro,
 fazendo conexão com os seus conteúdos.

 obs: o conteúdo tem que está na mesma ordem.
...
*/
 export default function initTab(){
    ...
    tabDescription[0].classList.add("ativo") // inicia da primeira section
